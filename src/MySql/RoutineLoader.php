...
class RoutineLoader
{
  ...
  /**
   * Name of the class for return method names.
   *
   * @var string
   */
  private $myMangler;
  ...
  protected function readConfigFile($theConfigFilename)
  {
    ...
    $this->myMangler                    = Util::getSetting($settings, false, 'loader', 'mangler');
  }
  ...
  //--------------------------------------------------------------------------------------------------------------------
  /**
   * Getting same values from array.
   *
   * @param $input array
   *
   * @return array
   */
  private function getArrayNotUnique($input)
  {
    $duplicates = [];
    $processed  = [];
    foreach ($input as $i)
